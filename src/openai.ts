...
import {generateRegistrationProfile} from "./profile-generator.js";
...
export class OpenAIClient {
    ...
    constructor(options: OpenAIClientOptions) {
        ...
        setGlobalDispatcher(createProxyDispatcher(resolveProxyUrl(), shouldAllowInsecureTLS()));
    ...
    private async completeAboutYou(): Promise<string> {
        ...
        const profile = await generateRegistrationProfile();
